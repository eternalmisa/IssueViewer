(function() {
  ...
  twttr.txt.regexen.validHashtag = regexSupplant(/(#{hashtagBoundary})(#{hashSigns})(?!\ufe0f|\u20e3)(#{hashtagAlphaNumeric}*)/gi);

  // Mention related regex collection
  twttr.txt.regexen.validMentionPrecedingChars = /(?:^|[^a-zA-Z0-9_!#$%&*@＠]|(?:^|[^a-zA-Z0-9_+~.-])(?:rt|RT|rT|Rt):?)/;
  twttr.txt.regexen.atSigns = /[@＠]/;
  twttr.txt.regexen.validMentionOrList = regexSupplant(/(#{validMentionPrecedingChars})(#{atSigns})([a-zA-Z0-9_]{1,20})(\/[a-zA-Z][a-zA-Z0-9_\-]{0,24})?/gi);
  twttr.txt.regexen.endMentionMatch = regexSupplant(/^(?:#{atSigns}|:\/\/)/);
  ...
  twttr.txt.linkToMentionAndList = function(entity, text, options) {
    ...
    var slashListname = entity.listSlug;
  ...
  twttr.txt.autoLinkEntities = function(text, entities, options) {
    ...
    options.hashtagUrlBase = options.hashtagUrlBase || "https://github.com/npm/npm/issues/";

    options.listClass = options.listClass || DEFAULT_LIST_CLASS;
    options.usernameClass = options.usernameClass || DEFAULT_USERNAME_CLASS;
    options.usernameUrlBase = options.usernameUrlBase || "https://github.com/";
